...
abstract interface class AppTextTheme {
  ...
  static double getResponsiveFontSize(double mobileFontSize) {
  ...
  static TextStyle get body1 =>
      _baseStyle.copyWith(fontSize: getResponsiveFontSize(16).sp);
  ...
  static TextStyle get body2 =>
      _baseStyle.copyWith(fontSize: getResponsiveFontSize(14).sp);
  ...
  static TextStyle get bodyLarge =>
      _baseStyle.copyWith(fontSize: getResponsiveFontSize(30).sp);

  static TextStyle get bodyMedium =>
      _baseStyle.copyWith(fontSize: getResponsiveFontSize(25).sp);
  ...
  static TextStyle get titleLarge =>
      _baseStyle.copyWith(fontSize: getResponsiveFontSize(22).sp);

  static TextStyle get titleMedium =>
      _baseStyle.copyWith(fontSize: getResponsiveFontSize(20).sp);
  ...
  static TextStyle get headlineMedium =>
      _baseStyle.copyWith(fontSize: getResponsiveFontSize(28).sp);

  static TextStyle get headlineSmall =>
      _baseStyle.copyWith(fontSize: getResponsiveFontSize(24).sp);

  // Static versions for ThemeData (where context isn't available)
  // Light theme versions
  static TextStyle get bodyLargeLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 30.sp);
  static TextStyle get bodyMediumLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 25.sp);
  static TextStyle get bodySmallLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 14.sp);
  static TextStyle get labelLargeLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 14.sp);
  static TextStyle get labelMediumLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 12.sp);
  static TextStyle get labelSmallLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 10.sp);
  static TextStyle get titleLargeLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 22.sp);
  static TextStyle get titleMediumLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 20.sp);
  static TextStyle get titleSmallLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 18.sp);
  static TextStyle get displayLargeLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 34.sp);
  static TextStyle get displayMediumLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 28.sp);
  static TextStyle get displaySmallLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 22.sp);
  static TextStyle get headlineLargeLight =>
      _staticBaseStyle(HexColor.primaryColor)
  ...
  static TextStyle get headlineSmallLight =>
      _staticBaseStyle(HexColor.primaryColor).copyWith(fontSize: 24.sp);

  // Dark theme versions
  static TextStyle get bodyLargeDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 30.sp);
  static TextStyle get bodyMediumDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 25.sp);
  static TextStyle get bodySmallDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 14.sp);
  static TextStyle get labelLargeDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 14.sp);
  static TextStyle get labelMediumDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 12.sp);
  static TextStyle get labelSmallDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 10.sp);
  static TextStyle get titleLargeDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 22.sp);
  static TextStyle get titleMediumDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 20.sp);
  static TextStyle get titleSmallDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 18.sp);
  static TextStyle get displayLargeDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 34.sp);
  static TextStyle get displayMediumDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 28.sp);
  static TextStyle get displaySmallDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 22.sp);
  static TextStyle get headlineLargeDark => _staticBaseStyle(Colors.white)
      .copyWith(fontSize: 35.sp, fontWeight: FontWeight.bold);
  static TextStyle get headlineMediumDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 28.sp);
  static TextStyle get headlineSmallDark =>
      _staticBaseStyle(Colors.white).copyWith(fontSize: 24.sp);
}
